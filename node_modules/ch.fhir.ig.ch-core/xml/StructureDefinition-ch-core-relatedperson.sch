...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:RelatedPerson/f:telecom/f:use</sch:title>
    <sch:rule context="f:RelatedPerson/f:telecom/f:use">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:RelatedPerson/f:telecom/f:period</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:RelatedPerson/f:communication</sch:title>
    <sch:rule context="f:RelatedPerson/f:communication">
