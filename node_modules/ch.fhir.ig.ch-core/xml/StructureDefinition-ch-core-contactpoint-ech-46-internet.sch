...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:ContactPoint/f:use</sch:title>
    <sch:rule context="f:ContactPoint/f:use">
  ...
  <sch:pattern>
    <sch:title>f:ContactPoint/f:period</sch:title>
    <sch:rule context="f:ContactPoint/f:period">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
